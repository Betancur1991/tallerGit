...
SubProceso  menuopciones ( opcion,propietario,placa,fecha )
	segun opcion hacer
		...
		2:
			...
			leer reparacion;
			escribir " el vehiculo tuvo las siguientes reparaciones: ", reparacion;
		3:
...
Proceso Tienda_Maquinista
	...
	menuinicial();
	leer opcion;
	menuopciones(opcion,propietario,placa,fecha);
