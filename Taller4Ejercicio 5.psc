SubProceso operacion_realizada (a,b)
	...
	Escribir "El resultado de multiplicar la posicion ","(",a,",",b,")"," es ",matriz[a+1,b+1];
FinSubProceso

SubProceso Tabla_de_multiplicar()
...
Proceso sin_titulo
	...
	Escribir "ingrese la fila y la columna correspondiente a la multiplicacion que desea conocer";
	escribir "fila que desea conocer";
	leer c;
	escribir "columna que desea conocer";
	leer d;
	
	operacion_realizada(c,d);
